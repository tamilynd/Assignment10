...
namespace Assignment10.Migrations
{
    ...
    [Migration("20210331011021_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment10.Models.BowlerScores", b =>
                {
            ...
            modelBuilder.Entity("Assignment10.Models.Bowlers", b =>
                {
                    b.Property<long>("BowlerId")
                        .HasColumnName("BowlerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment10.Models.MatchGames", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnName("MatchID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment10.Models.Teams", b =>
                {
                    b.Property<long>("TeamId")
                        .HasColumnName("TeamID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment10.Models.Tournaments", b =>
                {
            ...
            modelBuilder.Entity("Assignment10.Models.TourneyMatches", b =>
                {
                    b.Property<long>("MatchId")
                        .HasColumnName("MatchID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment10.Models.ZtblBowlerRatings", b =>
                {
            ...
            modelBuilder.Entity("Assignment10.Models.ZtblSkipLabels", b =>
                {
            ...
            modelBuilder.Entity("Assignment10.Models.ZtblWeeks", b =>
                {
            ...
            modelBuilder.Entity("Assignment10.Models.BowlerScores", b =>
                {
                    b.HasOne("Assignment10.Models.Bowlers", "Bowler")
            ...
            modelBuilder.Entity("Assignment10.Models.Bowlers", b =>
                {
                    b.HasOne("Assignment10.Models.Teams", "Team")
                        .WithMany("Bowlers")
            ...
            modelBuilder.Entity("Assignment10.Models.MatchGames", b =>
                {
                    b.HasOne("Assignment10.Models.TourneyMatches", "Match")
                        .WithMany("MatchGames")
            ...
            modelBuilder.Entity("Assignment10.Models.TourneyMatches", b =>
                {
                    b.HasOne("Assignment10.Models.Teams", "EvenLaneTeam")
                        .WithMany("TourneyMatchesEvenLaneTeam")
                        .HasForeignKey("EvenLaneTeamId");

                    b.HasOne("Assignment10.Models.Teams", "OddLaneTeam")
                        .WithMany("TourneyMatchesOddLaneTeam")
                        .HasForeignKey("OddLaneTeamId");

                    b.HasOne("Assignment10.Models.Tournaments", "Tourney")
